...
var translations = map[string]string{
    ...
    "action.edit_existing": "Edit Existing Article",
    ...
    "entry.edit.label": "Edit article",
    "entry.edit.title": "Edit article",
    "entry.external_link.label": "Externer Link",
    "entry.comments.label": "Kommentare",
    "entry.comments.title": "Kommentare anzeigen",
    "entry.actions.label": "All Actions",
    "entry.actions.title": "Show all actions available to this entry",
    ...
    "page.add_entry.title": "Save article",
    "page.add_entry.label.url": "URL",
    "page.add_entry.submit": "Save",
    ...
    "page.keyboard_shortcuts.proxy_images": "Retrieve article images via proxy",
    ...
    "page.keyboard_shortcuts.toggle_nsfw": "Switch NSFW mode",
    ...
    "page.integration.bookmarklet.entry.name": "Save Article to Miniflux",
    "page.integration.bookmarklet.entry.help": "This special link allows you to save an page as article directly by using a bookmark in your web browser.",
    ...
    "error.entry_mandatory_fields": "The URL and the feed are mandatory.",
    "error.entry_existed": "Cannot create article, it already exists in the feed.",
    ...
    "form.feed.label.nsfw": "Not Safe For Work(NSFW)",
    "form.entry.label.title": "Title",
    "form.entry.label.author": "Author",
    "form.entry.label.url": "URL",
    "form.entry.label.comments_url": "Comments URL",
    "form.entry.label.feed": "Feed",
    "form.entry.label.all_feeds": "All",
    "form.entry.label.content": "Content",
    "form.entry.label.code": "Code",
    "form.entry.label.preview": "Preview",
    ...
    "form.prefs.select.theme_light_serif": "Light - Serif",
    "form.prefs.select.theme_light_sans_serif": "Light - Sans Serif",
    "form.prefs.select.theme_dark_serif": "Dark - Serif",
    "form.prefs.select.theme_dark_sans_serif": "Dark - Sans Serif",
    "form.prefs.select.theme_system_serif": "System - Serif",
    "form.prefs.select.theme_system_sans_serif": "System - Sans Serif",
    "form.prefs.label.view": "View",
    "form.prefs.select.view_default": "Default",
    "form.prefs.select.view_list": "List View",
    "form.prefs.select.view_masonry": "Masonry View",
    ...
    "entry.scraper.label": "抓取",
    "entry.scraper.title": "抓取外部链接",
    "entry.scraper.completed": "完成",
    "entry.edit.label": "编辑文章",
    "entry.edit.title": "编辑文章",
    "entry.external_link.label": "外部链接",
    "entry.comments.label": "评论",
    "entry.comments.title": "查看评论",
    "entry.actions.label": "更多",
    "entry.actions.title": "显示适用于此文章的全部操作",
    ...
    "entry.shared_entry.title": "打开分享链接",
    ...
    "page.add_entry.title": "保存文章",
    "page.add_entry.label.url": "网址",
    "page.add_entry.submit": "保存",
    ...
    "page.keyboard_shortcuts.proxy_images": "使用代理获取文章图片",
    ...
    "page.keyboard_shortcuts.toggle_nsfw": "NSFW 模式开关",
    "page.users.title": "用户",
    ...
    "page.integration.miniflux_api": "Miniflux API",
    "page.integration.miniflux_api_endpoint": "API 地址",
    ...
    "page.integration.bookmarklet.name": "新增订阅到 Miniflux",
    "page.integration.bookmarklet.instructions": "拖动这个链接到书签",
    "page.integration.bookmarklet.help": "你可以打开这个特殊的书签来直接订阅网站",
    "page.integration.bookmarklet.entry.name": "保存文章到 Miniflux",
    "page.integration.bookmarklet.entry.help": "你可以打开这个特殊的书签来直接将网页保存为文章",
    ...
    "page.new_api_key.title": "新建 API 密钥",
    ...
    "error.invalid_feed_url": "源网址无效。",
    "error.invalid_site_url": "无效的网站网址。",
    "error.feed_url_not_empty": "源网址不能为空。",
    "error.site_url_not_empty": "网站网址不能为空。",
    "error.feed_title_not_empty": "源标题不能为空。",
    "error.feed_category_not_found": "此类别不存在或不属于该用户。",
    "error.user_mandatory_fields": "必须填写用户名",
    "error.entry_mandatory_fields": "必须填写网址和源",
    "error.entry_existed": "无法创建文章，该文章在指定源中已存在。",
    "error.api_key_already_exists": "此 API 密钥已存在。",
    "error.unable_to_create_api_key": "无法创建 API 密钥。",
    ...
    "form.feed.label.nsfw": "包含不适合工作场合(NSFW)的内容",
    "form.entry.label.title": "标题",
    "form.entry.label.author": "作者",
    "form.entry.label.url": "文章网址",
    "form.entry.label.comments_url": "评论网址",
    "form.entry.label.feed": "源",
    "form.entry.label.all_feeds": "全部",
    "form.entry.label.content": "内容",
    "form.entry.label.code": "代码",
    "form.entry.label.preview": "预览",
    "form.entry.label.readability": "使用 Readability 解析",
    "form.entry.label.cookies": "Cookies",
    "form.entry.label.cookies_placeholder":"以制表符分隔的“名称-值”表格，如：“name\tvalue”",
    ...
    "form.prefs.select.theme_light_serif": "浅色 - 衬线体",
    "form.prefs.select.theme_light_sans_serif": "浅色 - 无衬线体",
    "form.prefs.select.theme_dark_serif": "深色 - 衬线体",
    "form.prefs.select.theme_dark_sans_serif": "深色 - 无衬线体",
    "form.prefs.select.theme_system_serif": "跟随系统 - 衬线体",
    "form.prefs.select.theme_system_sans_serif": "跟随系统 - 无衬线体",
    "form.prefs.label.view": "视图",
    "form.prefs.select.view_default": "默认",
    "form.prefs.select.view_list": "列表视图",
    "form.prefs.select.view_masonry": "瀑布流视图",
    ...
    "form.integration.fever_endpoint": "Fever API 地址:",
    ...
    "form.integration.nunux_keeper_endpoint": "Nunux Keeper API 地址",
...
var translationsChecksums = map[string]string{
	"de_DE": "068fdaa24f2f6ffbc3ffffb651a378b976ee7388ad7e212f585f071f929c66ea",
	"en_US": "7121614396bf2abb147b7c01b23003c7dbe5ed69915579a721f34ef1b78dc263",
	"es_ES": "95e0206ed98ac52b2c44dcf4f9e576cb37a80a136341f277c041f168b3c006a4",
	"fr_FR": "b7d4a969755493ce643af1eb8fd3d74f06040bec340c0d4ef7532b7f89280018",
	"it_IT": "f53f24908ea29e30c4aa1de4f5ce23268a952f5d210215dc4206e55e15997d34",
	"ja_JP": "6c930dff3c908b59edbb8fb6604782ae8661eb506212a7a826de780bf42e432b",
	"nl_NL": "c5d6ee4530669f716e06111fd30fb1dbf10656b17657d26aee118de7869f9a63",
	"pl_PL": "ad9762f244f3c822fb7f5f41b5e31965ac50c8d2c5da5861325f7f98b1ad23a0",
	"pt_BR": "6a1bf3313445bbef9e96a9f0a024cd1e8092b90df300430b83586c551a1ffe95",
	"ru_RU": "25b71575e0f82921b57f05c7aa0a59db4e220fc58a9f50cedb66f0f1b80d2e90",
	"zh_CN": "5dfd674d02c341845d29b643c3e787b45f5e247d931a5ec1edbdb7723e9329d2",
}
